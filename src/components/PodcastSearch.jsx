...
const PodcastSearch = () => {
  return (
    <div className="bg-Banner md:py-12 md:my-0 md:mx-0 py-6 px-8">
      <div className="container mx-auto bg-podcastSearch rounded-md md:px-10 md:pt-10 md:pb-2 p-4">
        {/* Content */}
        <div>
          {/* Search Input */}
          ...
          <div className="mt-6 flex flex-wrap md:flex-nowrap gap-2 md:gap-4 justify-start md:justify-end">
            <div className="bg-SearchBtnBg md:text-lg font-semibold gap-2 px-8 py-1 rounded-md cursor-pointer">
