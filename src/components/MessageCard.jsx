const MessageCard = ({ img, name, text, status }) => {
  return (
    <div className="w-full bg-Banner md:bg-white lg:pl-4 px-1 pt-3 cursor-pointer border-b border-b-slate-300 lg:border-b-0">
      {/* Content */}
      <div className="flex justify-between lg:gap-2 gap-4 items-start">
        ...
        <div className="w-2/12 pt-3 lg:pt-0">
          <div className="relative flex justify-center">
            ...
            />
            <div className="md:hidden absolute xl:right-[10%] right-2 lg:-bottom-[7px] bottom-[-4px]">
              <i className="fa-solid fa-circle text-green-600 text-[6px] lg:text-[12px]"></i>
            </div>
          </div>
        </div>
        {/* Bordered Content */}
        <div className="w-10/12 flex justify-between  lg:border-b lg:border-b-slate-400 pt-3 pb-3">
